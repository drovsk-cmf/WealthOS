...
-- não entram no cálculo de debt_stress do motor CFA.
...
'Indica se a dívida possui garantia real (imóvel, veículo, equipamento). Relevante apenas para type IN (loan, financing). Usado pelo motor CFA para calcular debt_stress: passivos colateralizados não entram no cálculo de stress de dívida descoberta.';
