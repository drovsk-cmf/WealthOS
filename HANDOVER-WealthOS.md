...
### 3.4 Código Fonte (148 arquivos em src/, 43 suítes de teste, 581 assertions)

```
src/
├── __tests__/                    # 43 suítes de teste (Jest + RTL), 581 assertions
