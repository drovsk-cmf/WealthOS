...
export const ASSET_CATEGORY_LABELS: Record<AssetCategory, string> = {
  real_estate: "Imóvel",
  vehicle: "Veículo",
  vehicle_auto: "Automóvel",
  vehicle_moto: "Motocicleta",
  vehicle_recreational: "Embarcação/Trailer",
  vehicle_aircraft: "Aeronave",
  electronics: "Eletrônico",
  jewelry: "Jóia/Relógio",
  fashion: "Moda/Acessório",
  furniture: "Móvel/Decoração",
  sports: "Esporte/Lazer",
  collectibles: "Colecionável/Arte",
  other: "Outro",
  restricted: "Restrito",
};

export const ASSET_CATEGORY_OPTIONS: { value: AssetCategory; label: string; description: string }[] = [
  { value: "real_estate", label: "Imóvel", description: "Casa, apartamento, terreno, sala comercial" },
  { value: "vehicle_auto", label: "Automóvel", description: "Carro, SUV, caminhonete" },
  { value: "vehicle_moto", label: "Motocicleta", description: "Moto, scooter, quadriciclo" },
  { value: "vehicle_recreational", label: "Embarcação/Trailer", description: "Lancha, barco, jet ski, trailer" },
  { value: "vehicle_aircraft", label: "Aeronave", description: "Avião, helicóptero, ultraleve" },
  { value: "vehicle", label: "Veículo (outros)", description: "Veículo não classificado acima" },
  { value: "electronics", label: "Eletrônico", description: "Notebook, celular, TV, câmera" },
  { value: "jewelry", label: "Jóia/Relógio", description: "Jóias, relógios de luxo, pedras preciosas" },
  { value: "fashion", label: "Moda/Acessório", description: "Bolsas, roupas de grife, óculos de luxo" },
  { value: "furniture", label: "Móvel/Decoração", description: "Sofá, mesa, tapete, obra de decoração" },
  { value: "sports", label: "Esporte/Lazer", description: "Bicicleta, prancha, equipamento de ginástica" },
  { value: "collectibles", label: "Colecionável/Arte", description: "Quadros, esculturas, vinhos, selos, cards" },
  { value: "other", label: "Outro", description: "Equipamentos, instrumentos, miscelânea" },
...
const ASSET_CATEGORY_COLORS: Record<AssetCategory, string> = {
  ...
  vehicle_auto: "#2F7A68",
  vehicle_moto: "#4A7A6E",
  vehicle_recreational: "#7E9487",
  vehicle_aircraft: "#3A8A78",
  electronics: "#A97824",
  jewelry: "#A7794E",
  fashion: "#8B6B4A",
  furniture: "#6F6678",
...
const COA_MAP: Record<AssetCategory, string> = {
  ...
  vehicle_auto: "1.2.04",
  vehicle_moto: "1.2.04",
  vehicle_recreational: "1.2.04",
  vehicle_aircraft: "1.2.04",
  electronics: "1.2.05",
  jewelry: "1.2.06",
  fashion: "1.2.06",
  furniture: "1.2.06",
